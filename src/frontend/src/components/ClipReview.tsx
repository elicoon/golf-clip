...
export function ClipReview({ jobId, videoPath, onComplete }: ClipReviewProps) {
  ...
  // Handle accepting shot with current trajectory anyway (reluctant accept from feedback modal)
  ...
  // Handle accepting shot without trajectory (rejected tracer from feedback modal)
