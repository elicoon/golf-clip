# GolfClip Browser App E2E Test Plan

> **This is THE test plan for the Browser app.** When asked to test golf-clip, run this.

**Production URL:** https://browser-seven-sigma.vercel.app

**Goal:** Comprehensive E2E acceptance testing covering the complete user flow from video upload through shot detection, review, tracer configuration, and export.

**Execution:** Playwright MCP browser automation. Record results in `docs/test-reports/`.
