...
#### Acceptance Criteria
- [x] All 5 Playwright E2E test suites execute without import errors (`npx playwright test` exits cleanly)
- [ ] At least the tracer-renderer spec passes all its test cases against the dev server
- [x] Vitest unit tests continue to pass (`npm run test` — 405+ tests pass)
- [x] No Vitest config changes break existing test files
